module chu_mcs_bridge #(
    ...
    assign mcs_bridge_en  = (IO_0_address[DATA_WIDTH-1:24] == BRG_BASE[DATA_WIDTH-1:24]);

    // [22:0] -> 23-bit byte address. [22:2] -> 21-bit word address. [23] -> select video or mmio
    assign fp_video_cs    = mcs_bridge_en && (IO_0_address[23] == 'b1);
    assign fp_mmio_cs     = mcs_bridge_en && (IO_0_address[23] == 'b0);
